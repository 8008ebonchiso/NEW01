...
9. **コードの編集:**
    ...
    *  例：`client.html`を開いて、HTMLコードを変更して保存して、サーバーを止めて(ターミナルでCtrl + C)、再度サーバーを起動します(`python main.py`)。
    *  例：`server.py`を開いて、Pythonコードを変更して保存して、サーバーを止めて(ターミナルでCtrl + C)、再度サーバーを起動します(`python main.py`)。
